    ...
    public:
        ...
        void initialize_argument_parser(argument_parser &parser) override
        {
            parser.add_positional(
                ...
                "method",
                1,
                value<std::string>(&method)->required()
            ).add_positional(
                "argument",
                1,
        ...
        int main(const variables_map &variables) override
        {
            ...
            {
                const auto handle = bunsan::protobuf::text::parse_make<
                    bacs::external::submit::Handle
                >(argument);
